...
def main():
    ...
    with tab3:
        ...
        **Назначение:** Автоматический контроль качества сварных соединений на основе компьютерного зрения.
        ...
        - **Трещина** — разрыв металла шва или околошовной зоны
        - **Пористость** — газовые поры в металле шва
        - **Брызги** — частицы металла на поверхности
        ...
        - Оптимальный порог уверенности: 0.25-0.35
        - Модель "Ансамбль" дает наилучшие результаты
        
        ### Технические требования:
        - Форматы: JPG, JPEG, PNG, BMP
        - Максимальный размер: 200 MB
        - Рекомендованное разрешение: от 640x640 пикселей
        ...
        **Termit Weld CV** © 2026
        ...
        fbetas = [0.5, 1.0, 2.0, 3.0]
        meanings = ["Точность важнее", "Сбалансированный", "Recall важнее", "Максимальный Recall"]
        
        df_beta = pd.DataFrame({"Beta": fbetas, "Приоритет": meanings})
